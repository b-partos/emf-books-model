...
public class BooksPackageImpl extends EPackageImpl implements BooksPackage {
	 ...
	 * @see com.partosb.emf.books.BooksPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BooksPackage init() {
		...
		BooksPackageImpl theBooksPackage = registeredBooksPackage instanceof BooksPackageImpl
				? (BooksPackageImpl) registeredBooksPackage
	 ...
	 * @generated
	 */
	public EReference getRoot_Books() {
	...
	public void createPackageContents() {
		...
		createEReference(rootEClass, ROOT__BOOKS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getBook_Isbn(), ecorePackage.getEString(), "isbn", null, 0, 1, Book.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBook_Authors(), this.getPerson(), null, "authors", null, 0, -1, Book.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getBook_Publisher(), this.getPublisher(), null, "publisher", null, 0, 1, Book.class,
		...
		initEAttribute(getPublisher_Name(), ecorePackage.getEString(), "name", null, 0, 1, Publisher.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(rootEClass, Root.class, "Root", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRoot_People(), this.getPerson(), null, "people", null, 0, -1, Root.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getRoot_Books(), this.getBook(), null, "books", null, 0, -1, Root.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getRoot_Publishers(), this.getPublisher(), null, "publishers", null, 0, -1, Root.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
