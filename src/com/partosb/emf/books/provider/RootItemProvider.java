...
/**
 * This is the item provider adapter for a {@link com.partosb.emf.books.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BooksPackage.Literals.ROOT__PEOPLE);
			childrenFeatures.add(BooksPackage.Literals.ROOT__BOOKS);
			childrenFeatures.add(BooksPackage.Literals.ROOT__PUBLISHERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(BooksPackage.Literals.ROOT__PEOPLE, BooksFactory.eINSTANCE.createPerson()));

		newChildDescriptors
				.add(createChildParameter(BooksPackage.Literals.ROOT__BOOKS, BooksFactory.eINSTANCE.createBook()));

		newChildDescriptors.add(
				createChildParameter(BooksPackage.Literals.ROOT__PUBLISHERS, BooksFactory.eINSTANCE.createPublisher()));
	}
